...
Clazz.load (["java.util.Hashtable", "JU.BS", "$.V3"], "JS.CIPData", ["JU.Lst", "$.Measure", "$.P4", "JS.CIPChirality", "JU.BSUtil", "$.Logger"], function () {
...
this.htKekuleBond =  new java.util.Hashtable ();
...
function () {
this.setAuxiliary = this.vwr.getBoolean (603979960);
try {
